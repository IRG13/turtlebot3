...
def main(args=None):
    ...
    sub_img = node.create_subscription(sensor_msgs.msg.Image, options.topic, detect_and_draw, qos_profile=1)
    sub_cpimg = node.create_subscription(sensor_msgs.msg.CompressedImage, options.ctopic, compressed_detect_and_draw, qos_profile=1)
